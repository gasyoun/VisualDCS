...
| [`vedaweb`](vedaweb/README.md) | 55MB | 9 | VedaWeb 2.0 (Uni Köln) Rig-Veda bulk export — catalog + 4 core annotation layers (Casaretto et al. accented word-split/morphology, gzipped; lemmatization+dictionary refs; Scarlata & Widmer accented text; Lubotsky padapāṭha), 10,552 stanzas each, plus Metrical Data (Kiss & Kölligan 2024, 10,551 stanzas, meter label + scansion, H360); GRA crosswalk (H097); [`LAYERS_TRIAGE.md`](vedaweb/LAYERS_TRIAGE.md) (H098, updated H360) — GO/DECIDE triage of the remaining catalog layers, rights-honesty finding (only 2/36 resources carry an explicit machine-readable license), 4 of the DECIDE layers since confirmed GO by H359 |
