...
| [`vedaweb`](vedaweb/README.md) | 56MB | 9 | VedaWeb 2.0 (Uni Köln) Rig-Veda bulk export — catalog + 4 core annotation layers (Casaretto et al. accented word-split/morphology, gzipped; lemmatization+dictionary refs; Scarlata & Widmer accented text; Lubotsky padapāṭha), 10,552 stanzas each; GRA crosswalk (H097); [`LAYERS_TRIAGE.md`](vedaweb/LAYERS_TRIAGE.md) (H098) — GO/DECIDE triage of the remaining 34 catalog layers (rights-honesty finding: only 2/36 resources carry an explicit machine-readable license); Elizarenkova (1989-1999) Russian RV translation (CC BY 4.0, confirmed 08-07-2026) → [RussianTranslation](https://github.com/gasyoun/SanskritLexicography/tree/master/RussianTranslation) citation/context witness (H361) |
