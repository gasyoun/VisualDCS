...
catalog ([`catalog.json`](https://github.com/gasyoun/VisualDCS/blob/main/non-derived/vedaweb/catalog.json), 36 resources, retrieved 08-07-2026). This is a
...
| 6 | **Metrical Data, VedaWeb 2024** (Van Nooten & Holland base) | plainText | 2 | — | VedaWeb team (Kiss & Kölligan), computer-generated via open-source [`viracitapada`](https://github.com/VedaWebProject/viracitapada) | null | **GO (confirmed 08-07-2026, landed via H360)** | **SanskritKaraoke meter labels** |
