...
uses
  ...
  Forms, Windows, poisk, tema1, keybrd, help1, repo1, gram, gdepo, gfr, ver1,
  sfo, dcon, ssv, sh1, ngh, depo1, ent1, h1, ht1, tt1, depo2, grmx, unit2xxx,
  ds1, tcf, lns1, wrf, vf2, tcompare, StAns, TsN, rusk, trunit, vd1, omf,
  parals, lgg, frs, wTC, Tinfo, dF, syn, fdic, vpref, lex2, lpak, params,
  sintagma1, kn, ched1, Edepo, acat, Thank, th2, krr, trwin, tachartlazaruspkg,
  FrameViewer09, Fst, info1, wcard1;//, //tachartlazaruspkg;
...
begin
  ...
  Application.CreateForm(TFSinta, FSinta);
  Application.CreateForm(Tinf1, inf1);
  Application.CreateForm(TWCard, WCard);
  Application.Run;
