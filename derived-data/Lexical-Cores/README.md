...
| [Приложение 10. «Список стабильной ядерной лексики за всю историю...»](https://github.com/gasyoun/VisualDCS/blob/main/derived-data/Lexical-Cores/Приложение%2010.%20%C2%ABСписок%20стабильной%20ядерной%20лексики%20за%20всю%20историю%20санскритской%20литературы%2C%20отраженную%20в%20корпусе%C2%BB.xls) | **440** | The tightest curated list: lemmas that stay in the "core vocabulary" across every historical period of the corpus (lemma + POS). This is the closest thing to a canonical "most frequent Sanskrit words" list. |
...
- [Приложение 1. «Данные общего параметрического анализа...»](https://github.com/gasyoun/VisualDCS/blob/main/derived-data/Lexical-Cores/Приложение%201.%20%20%C2%ABДанные%20общего%20параметрического%20анализа%20грамматичских%20характристик%20корпуса%C2%BB%20%20(таблица%20MS%20Excel%2097)..xlsx) — general parametric grammar-characteristics analysis.
